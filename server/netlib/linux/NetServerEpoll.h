...
protected:
	...
	CThreadSafeIDStorage< CSmartPtr<CEpollEventRouter> >	m_EventRouterPool;
...
public:
	...
	CSmartPtr<CEpollEventRouter>  CreateEventRouter();
	CSmartPtr<CEpollEventRouter> GetEventRouter(UINT ID);
	bool DeleteEventRouter(CSmartPtr<CEpollEventRouter> pEventRouter);


	bool BindSocket(SOCKET Socket,CSmartPtr<CEpollEventRouter>  pEpollEventRouter, bool UseLTMode);
	bool UnbindSocket(SOCKET Socket, CSmartPtr<CEpollEventRouter>  pEpollEventRouter);
