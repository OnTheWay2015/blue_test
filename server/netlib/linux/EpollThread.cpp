...
bool CEpollThread::BindSocket(SOCKET Socket,  CSmartPtr<CEpollEventRouter > pEpollEventRouter, bool UseLTMode)
{
...
BOOL CEpollThread::OnRun()
{
	...
	if(EventCount>0)
	{
		...
		for(int i=0;i<EventCount;i++)
		{
			...
			auto pEpollEventRouter=m_pServer->GetEventRouter(Param64.LowPart);//todo 直接引用到 router 
