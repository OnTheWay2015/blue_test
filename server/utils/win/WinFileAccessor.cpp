...
UINT64 CWinFileAccessor::GetSize()
{
	if(m_hFile!=INVALID_HANDLE_VALUE)
	{
...
UINT64 CWinFileAccessor::Read(LPVOID pBuff,UINT64 Size)
{
	if(m_hFile!=INVALID_HANDLE_VALUE)
	{
		DWORD RealSize=0;
...
UINT64 CWinFileAccessor::Write(LPCVOID pBuff,UINT64 Size)
{
	if(m_hFile!=INVALID_HANDLE_VALUE)
	{
		DWORD RealSize=0;
...
BOOL CWinFileAccessor::Seek(INT64 Offset,int SeekMode)
{
	if(m_hFile!=INVALID_HANDLE_VALUE)
	{
		UINT64_CONVERTER Size;
...
UINT64 CWinFileAccessor::GetCurPos()
{
	if(m_hFile!=INVALID_HANDLE_VALUE)
	{
		UINT64_CONVERTER Size;
