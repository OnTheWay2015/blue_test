...
public:	
	...
	virtual UINT64 Read(LPVOID pBuff,UINT64 Size)=0;
	virtual UINT64 Write(LPCVOID pBuff,UINT64 Size)=0;


	virtual BOOL IsEOF()=0;
	
	virtual BOOL Seek(INT64 Offset,int SeekMode)=0;
	virtual UINT64 GetCurPos()=0;
