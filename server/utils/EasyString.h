...
public:
	...
	void SetStringRef(const char * pStr, int Size, STRING_CODE_PAGE CodePage = STRING_CODE_PAGE_AUTO);
	void SetStringRef(const WCHAR * pStr, int Size, STRING_CODE_PAGE CodePage = STRING_CODE_PAGE_AUTO);
	void SetString(const char * pStr, int Size, STRING_CODE_PAGE CodePage = STRING_CODE_PAGE_AUTO);
	void SetString(const WCHAR * pStr, int Size, STRING_CODE_PAGE CodePage = STRING_CODE_PAGE_AUTO);
	void AppendString(const char * pStr, int Size, STRING_CODE_PAGE CodePage = STRING_CODE_PAGE_AUTO);
	void AppendString(const WCHAR * pStr, int Size, STRING_CODE_PAGE CodePage = STRING_CODE_PAGE_AUTO);
...
template<>
inline void CEasyStringT<char>::SetString(const char* pStr, int Size, STRING_CODE_PAGE CodePage)
{
	if (pStr)
	{
		if (Size < 0)
...
template<>
inline void CEasyStringT<WCHAR>::SetString(const WCHAR * pStr, int Size, STRING_CODE_PAGE CodePage)
{
	if (pStr)
	{
		if (Size < 0)
...
template<>
inline void CEasyStringT<char>::SetString(const WCHAR * pStr, int Size, STRING_CODE_PAGE CodePage)
{
	if (pStr)
	{
		if (Size < 0)
...
template<>
inline void CEasyStringT<WCHAR>::SetString(const char * pStr, int Size, STRING_CODE_PAGE CodePage)
{
	if (pStr)
	{
		if (Size < 0)
...
template<>
inline void CEasyStringT<char>::SetStringRef(const char * pStr, int Size, STRING_CODE_PAGE CodePage)
{
	if (pStr)
	{
		if (Size < 0)
...
template<>
inline void CEasyStringT<WCHAR>::SetStringRef(const char * pStr, int Size, STRING_CODE_PAGE CodePage)
{
	SetString(pStr, Size, CodePage);
}

template<>
inline void CEasyStringT<char>::SetStringRef(const WCHAR * pStr, int Size, STRING_CODE_PAGE CodePage)
{
	SetString(pStr, Size, CodePage);
}

template<>
inline void CEasyStringT<WCHAR>::SetStringRef(const WCHAR * pStr, int Size, STRING_CODE_PAGE CodePage)
{
	ReleaseBuffer();
...
template<>
inline void CEasyStringT<char>::AppendString(const char * pStr, int Size, STRING_CODE_PAGE CodePage)
{
	if (Size < 0)
		Size = GetStrLen(pStr);
	if (pStr && (Size > 0))
...
template<>
inline void CEasyStringT<WCHAR>::AppendString(const WCHAR * pStr,int Size, STRING_CODE_PAGE CodePage)
{
	if (Size < 0)
		Size = GetStrLen(pStr);
	if (pStr && (Size > 0))
...
template<>
inline void CEasyStringT<char>::AppendString(const WCHAR * pStr,int Size, STRING_CODE_PAGE CodePage)
{
	if (Size < 0)
		Size = GetStrLen(pStr);
	if (pStr && (Size > 0))
...
template<>
inline void CEasyStringT<WCHAR>::AppendString(const char * pStr,int Size, STRING_CODE_PAGE CodePage)
{
	if (Size < 0)
		Size = GetStrLen(pStr);
	if (pStr && (Size > 0))
