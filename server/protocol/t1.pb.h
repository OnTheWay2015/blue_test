...
PROTOBUF_NAMESPACE_OPEN
template<> ::t1::MSG_TEST* Arena::CreateMaybeMessage<::t1::MSG_TEST>(Arena*);
template<> ::t1::MSG_TEST_RES* Arena::CreateMaybeMessage<::t1::MSG_TEST_RES>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace t1 {
...
class MSG_TEST :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:t1.MSG_TEST) */ {
 public:
  MSG_TEST();
  virtual ~MSG_TEST();
...
class MSG_TEST_RES :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:t1.MSG_TEST_RES) */ {
 public:
  MSG_TEST_RES();
...
inline void MSG_TEST::set_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:t1.MSG_TEST.name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 MSG_TEST::_internal_packet_id() const {
  return packet_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MSG_TEST::packet_id() const {
  // @@protoc_insertion_point(field_get:t1.MSG_TEST.packet_id)
  return _internal_packet_id();
}
inline void MSG_TEST::_internal_set_packet_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  packet_id_ = value;
}
inline void MSG_TEST::set_packet_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline void MSG_TEST_RES::set_name_res(std::string&& value) {
  ...
  name_res_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:t1.MSG_TEST_RES.name_res)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 MSG_TEST_RES::_internal_packet_id() const {
  return packet_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MSG_TEST_RES::packet_id() const {
  // @@protoc_insertion_point(field_get:t1.MSG_TEST_RES.packet_id)
  return _internal_packet_id();
}
inline void MSG_TEST_RES::_internal_set_packet_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  packet_id_ = value;
}
inline void MSG_TEST_RES::set_packet_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_packet_id(value);
