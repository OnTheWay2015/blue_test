...
CSmartPtr<CBaseNetConnection> CProxyServiceDefault::CreateConnection(CIPAddress& RemoteAddress)
{
...
bool CProxyServiceDefault::DeleteConnection(CBaseNetConnection * pConnection)
{
