import { _decorator, Node, Graphics, Texture2D, Vec2, Event, EventTouch } from 'cc';
...
@ccclass('UISplitTexture')
export default class UISplitTexture extends UIScreen {
    @property(Node)
    textureRoot: Node | null = null;
    @property(Graphics)
    graphics: Graphics | null = null;
    @property(Texture2D)
    pic: Texture2D | null = null;
    ...
    //private splitTexture(texture: TexturePlus, polygons: Vec2[][]) {
