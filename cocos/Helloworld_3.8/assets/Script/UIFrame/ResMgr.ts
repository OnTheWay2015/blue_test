...
import { _decorator, js, Prefab, Asset,assetManager,Texture2D, error } from 'cc';
...
//     */
    ...
    private _prefabs: {[key: string]: Prefab} = js.createMap();               // 预制体缓存
//    /** 获取预制体 */
