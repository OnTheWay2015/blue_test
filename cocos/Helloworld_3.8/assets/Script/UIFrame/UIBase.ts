...
import { _decorator, Component, BlockInputEvents, Asset, warn, error,Node, UITransform } from 'cc';
...
//    /** 是否已经调用过preinit方法 */
    ...
    public view: Component | null = null;
...
//    /** 设置是否挡住触摸事件 */
    ...
    public setBlockInput(block: boolean) {
        if (!this._blocker) {
            ...
            //子节点按 siblingIndex 升序渲染，同层级节点按添加顺序渲染
