...
/* 
import { _decorator, UIRenderer, Texture2D, Enum, macro, Vec2 } from 'cc';
const {ccclass, menu, executeInEditMode, mixins, property} = _decorator;

import ScrollAssembler from "../Assemblers/MeshAssembler";

@ccclass('MeshTexture')
@executeInEditMode@menu('i18n:MAIN_MENU.component.ui/MeshTexture')@mixins(cc.BlendFunc)
export default class MeshTexture extends UIRenderer {
    @property(Texture2D)
    @property(Texture2D)
    get texture() {
    ...
    public tweenVec2(from: Vec2, to: Vec2, duration: number, onUpdate: (t: Vec2) => void, onComplete?: Function, delay: number = 0) {
    ...
    public tweenVec2Bezier(from: Vec2, to: Vec2, duration: number, onUpdate: (t: Vec2) => void, onComplete?: Function, delay: number = 0) {
        // let o: Record<string, cc.Vec2> = {_value: from};
        // Object.defineProperty(o, 'position', {
        // get: () => o._value,
        // set: (v: cc.Vec2) => { o._value = v; onUpdate && onUpdate(o._value); },
